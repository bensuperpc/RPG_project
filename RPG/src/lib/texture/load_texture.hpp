...
#if (__cplusplus == 201103L || __cplusplus == 201402L)
/*DEPRECATED*/ void load_texture(std::vector<sf::Texture> &, const std::string &);
/*DEPRECATED*/ void load_texture(std::vector<sf::Texture *> &, const std::string &);
...
void load_texture(std::vector<sf::Texture> &, std::string_view);
void load_texture(std::vector<std::unique_ptr<sf::Texture>> &, std::string_view);
void load_texture(std::vector<sf::Texture *> &, std::string_view);
